...
class INostrMetadataSyncSettings(Interface):
    ...
    base_url = schema.TextLine(
        title=_("label_base_url", default="Base URL"),
        description=_(
            "help_base_url",
    ...
    relays = schema.Tuple(
        ...
        description=_(
            "help_relays", default="One relay per line (e.g. ws://localhost:10547)"
        ),
    ...
    calendar_adapter_types = schema.List(
        title=_("label_calendar_adapter_types", default="Calendar adapter types"),
        description=_(
            "help_calendar_adapter_types",
    ...
    calendar_search_params = schema.TextLine(
        title=_("label_calendar_search_params", default="Event query parameters"),
        description=_(
            "help_calendar_search_params",
    ...
    amb_search_params = schema.TextLine(
        title=_("label_amb_search_params", default="AMB query parameters"),
        description=_(
            "help_amb_search_params",
